  ...
  return (
    <>
      <div className="w-full mx-auto lg:w-10/12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-3 xl:grid-cols-3 mb-8 md:gap-8">
        ...
        <div className="w-full shadow-md py-5 mb-6 rounded-lg bg-base-100 stats">
          <div className="stat">
